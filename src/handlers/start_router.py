...
from aiogram.utils.formatting import Bold, TextLink, as_line, as_list
...
async def cmd_private_start(message: Message, state: FSMContext):
    ...
    if user is None or user.avatar_id is None:
        ...
        await message.answer_photo(photo=photo, caption=caption, parse_mode=ParseMode.HTML, reply_markup=main_kb())
