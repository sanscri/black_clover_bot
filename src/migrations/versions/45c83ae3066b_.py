...
Revision ID: 45c83ae3066b
Revises: 
Create Date: 2025-11-27 15:35:57.457994
...
def upgrade() -> None:
    ...
    sa.Column('stats_id', sa.BigInteger(), nullable=False),
    sa.Column('grimoire_id', sa.BigInteger(), nullable=False),
